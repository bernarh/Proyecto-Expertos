...
?>
	...
	<form id="f_insertP", method="post" class="form-horizontal", action="" >
		...
		<div class="form-group">
			...
			<div class="col-xs-4">
			<input type="text" class="form-control" maxlength="11" minlength="8" name="nro_cuenta" id="nro_cuenta" value="<?php echo($_GET['cuenta']);?>"  />
			</div>	
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-1">
				<label class="radio-inline">
					<input type="radio"  name="genero"   id="radioM"  checked="<?php echo($_GET['genero'])?>"  />Masculino 
				</label>
			</div>	

			<div class="col-xs-1">
				 <label class="radio-inline">
				 	<input type="radio"  name="genero"  id="radioF" value="<?php echo($_GET['genero'])?>" />Femenino
				 </label>	
			</div>
		</div>
		 ...
		 <div class="form-group">
		 		<div class="col-xs-2"></div>
                  <div class="col-xs-5">
                           ...
                           <button type="button" class="btn btn-default" data-dismiss="modal" onClick="location.href='system.php?page=paciente'">Cancelar</button>
                  </div>
